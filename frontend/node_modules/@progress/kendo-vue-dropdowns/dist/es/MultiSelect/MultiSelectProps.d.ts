...
export interface MultiSelectProps extends FormComponentProps {
     ...
     */
    open?: (event: MultiSelectOpenEvent) => void;
    /**
     * Fires each time the popup of the MultiSelect is about to close.
     */
    close?: (event: MultiSelectCloseEvent) => void;
    /**
     * Fires each time the user focuses the MultiSelect.
     */
    focus?: (event: MultiSelectFocusEvent) => void;
    /**
     * Fires each time the MultiSelect gets blurred.
     */
    blur?: (event: MultiSelectBlurEvent) => void;
    /**
     ...
     */
    filterchange?: (event: MultiSelectFilterChangeEvent) => void;
    /**
     ...
     */
    pagechange?: (event: MultiSelectPageChangeEvent) => void;
    /**
